...
template void convert3dOrganizedRGB(cv::Mat &objDepth, cv::Mat &colImage, Eigen::Matrix3f &camIntrinsic, pcl::shared_ptr<pcl::PointCloud<pcl::PointXYZRGB>> objCloud);
template void convert3dOrganizedRGB(cv::Mat &objDepth, cv::Mat &colImage, Eigen::Matrix3f &camIntrinsic, pcl::shared_ptr<pcl::PointCloud<pcl::PointXYZRGBNormal>> objCloud);
...
template<class PointT>
float pointToPlaneICP(pcl::shared_ptr<pcl::PointCloud<PointT> > src, pcl::shared_ptr<pcl::PointCloud<PointT> > dst, Eigen::Matrix4f &offsetTransform, int max_iter, float rejection_angle, float max_corres_dist, float score_thres)
{
...
template float pointToPlaneICP<pcl::PointXYZRGBNormal>(pcl::shared_ptr<pcl::PointCloud<pcl::PointXYZRGBNormal> > pclSegment, pcl::shared_ptr<pcl::PointCloud<pcl::PointXYZRGBNormal> > pclModel, Eigen::Matrix4f &offsetTransform, int max_iter, float rejection_angle, float max_corres_dist, float score_thres);
template float pointToPlaneICP<pcl::PointSurfel>(pcl::shared_ptr<pcl::PointCloud<pcl::PointSurfel> > pclSegment, pcl::shared_ptr<pcl::PointCloud<pcl::PointSurfel> > pclModel, Eigen::Matrix4f &offsetTransform, int max_iter, float rejection_angle, float max_corres_dist, float score_thres);
...
template void outlierRemovalRadius(pcl::shared_ptr<pcl::PointCloud<pcl::PointXYZRGBNormal> > cloud_in, pcl::shared_ptr<pcl::PointCloud<pcl::PointXYZRGBNormal> > cloud_out, float radius, int min_num);
...
template void outlierRemovalStatistic(pcl::shared_ptr<pcl::PointCloud<pcl::PointXYZRGBNormal> > cloud_in, pcl::shared_ptr<pcl::PointCloud<pcl::PointXYZRGBNormal> > cloud_out, float std_mul, int num);
...
template void downsamplePointCloud<pcl::PointXYZRGBNormal>(pcl::shared_ptr<pcl::PointCloud<pcl::PointXYZRGBNormal> > cloud_in, pcl::shared_ptr<pcl::PointCloud<pcl::PointXYZRGBNormal> > cloud_out, float vox_size);
template void downsamplePointCloud<pcl::PointXYZRGB>(pcl::shared_ptr<pcl::PointCloud<pcl::PointXYZRGB> > cloud_in, pcl::shared_ptr<pcl::PointCloud<pcl::PointXYZRGB> > cloud_out, float vox_size);
template void downsamplePointCloud<pcl::PointXYZ>(pcl::shared_ptr<pcl::PointCloud<pcl::PointXYZ> > cloud_in, pcl::shared_ptr<pcl::PointCloud<pcl::PointXYZ> > cloud_out, float vox_size);
template void downsamplePointCloud<pcl::PointNormal>(pcl::shared_ptr<pcl::PointCloud<pcl::PointNormal> > cloud_in, pcl::shared_ptr<pcl::PointCloud<pcl::PointNormal> > cloud_out, float vox_size);
template void downsamplePointCloud<pcl::PointSurfel>(pcl::shared_ptr<pcl::PointCloud<pcl::PointSurfel> > cloud_in, pcl::shared_ptr<pcl::PointCloud<pcl::PointSurfel> > cloud_out, float vox_size);
...
// }
// template void passFilterPointCloud<pcl::PointXYZRGBNormal>(pcl::shared_ptr<pcl::PointCloud<pcl::PointXYZRGBNormal> > cloud_in, pcl::shared_ptr<pcl::PointCloud<pcl::PointXYZRGBNormal> > cloud_out, const std::string &axis, float min, float max);
// template void passFilterPointCloud<pcl::PointXYZRGB>(pcl::shared_ptr<pcl::PointCloud<pcl::PointXYZRGB> > cloud_in, pcl::shared_ptr<pcl::PointCloud<pcl::PointXYZRGB> > cloud_out, const std::string &axis, float min, float max);
...
// python run_ho3d.py --video_dirs BundleTrack/HO3D_v3/evaluation/SM1 --out_dir output
