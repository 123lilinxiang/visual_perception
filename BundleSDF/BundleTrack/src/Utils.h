...
template<class PointT>
float pointToPlaneICP(pcl::shared_ptr<pcl::PointCloud<PointT> > pclSegment,
                     pcl::shared_ptr<pcl::PointCloud<PointT> > pclModel,
...
template<class PointT>
inline void passFilterPointCloud(
    pcl::shared_ptr<pcl::PointCloud<PointT> > cloud_in,
    pcl::shared_ptr<pcl::PointCloud<PointT> > cloud_out,
...
template <class PointT>
void calNormalIntegralImage(pcl::shared_ptr<pcl::PointCloud<PointT>> cloud, int method, float max_depth_change_factor, float smooth_size,bool depth_dependent_smooth);
...
template<class PointT>
void cloudAMinusCloudB(pcl::shared_ptr<pcl::PointCloud<PointT>> cloudA, pcl::shared_ptr<pcl::PointCloud<PointT>> cloudB, pcl::shared_ptr<pcl::PointCloud<PointT>> cloud_out, const float dist_thres);
